...
public static class Program
{
	public static void Main()
	{
		...
		Console.WriteLine();
		Console.WriteLine($"  Start date: {dateTest2.GetDateString()}");
		Console.WriteLine($"  Minutes added: {date2mins}");
		Console.WriteLine($"  End date: {timeTurner.GetEndDate(dateTest2, date2mins).GetDateString()}");
		Console.WriteLine();
